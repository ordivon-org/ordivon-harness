...
After a successor WorkingSet commits, the prior attempt's transient Tool exchanges are cleared rather than promoted into the successor WorkingSet. The next Provider turn after selecting B therefore sees B rather than A plus stale discovery history. This transient exchange buffer is current-process cognition continuity in this slice; arbitrary later-process re-entry that reconstructs an unfinished Tool-exchange conversation is not claimed yet.
