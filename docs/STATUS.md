...
- P2 proves one bounded self-modification/promotion composition, and P3 proves one bounded improvement of that composition; neither is a permanent autonomous RSI controller. Source target discovery still receives an externally prepared source/evidence view, evaluator gates are externally configured, promotion triggering remains external, and generator/materializer/evaluator/promotion/Git authorities remain separate;
