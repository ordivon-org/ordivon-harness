# Ordivon Harness Research — Agent Operational Mediation
...
- Campaign-4 Counterevidence / Rebuttal Direct Dogfood v1 completed with `BOUNDED_DIRECT_SUPPORT`.
- Campaign-3 Real Rich-Effect Owner Dogfood v1 completed with `CAMPAIGN3_RICH_EFFECT_DIRECT_SUPPORT_IN_SCOPE`.
- Current Campaign-3 direct evidence covers bounded Runtime-owner partial multi-step realization, delayed realization evidence across a nonterminal observation boundary, exact CAS/currentness interference, and compensation/restoration without history erasure.
...
- Evidence index currently classifies 77 entries as historical and 0 as verified; historical implementation status does not erase bounded research standing owned by research closeouts, and no replacement verified receipt is minted merely to preserve a nonzero count.
...
1. [155 POST-HTTPX EVIDENCE CURRENTNESS REPAIR RESULT](155-POST-HTTPX-EVIDENCE-CURRENTNESS-REPAIR-V1-RESULT-AND-CLOSEOUT.md)
2. [154 POST-HTTPX EVIDENCE CURRENTNESS REPAIR CONTRACT](154-POST-HTTPX-EVIDENCE-CURRENTNESS-REPAIR-V1-CONTRACT.md)
3. [153 PROVIDER-FIRST HTTPX TRANSPORT CURRENT REVALIDATION](153-PROVIDER-FIRST-HTTPX-TRANSPORT-CURRENT-REVALIDATION-V1-RESULT-AND-CLOSEOUT.md)
4. [152 POST-WHEEL-REPAIR TYPED FRONTIER TOURNAMENT](152-POST-WHEEL-REPAIR-TYPED-FRONTIER-TOURNAMENT-V1.md)
5. [151 WHEEL PUBLIC API CONTRACT CURRENTNESS REPAIR RESULT](151-WHEEL-PUBLIC-API-CONTRACT-CURRENTNESS-REPAIR-V1-RESULT-AND-CLOSEOUT.md)
6. [150 WHEEL PUBLIC API CONTRACT CURRENTNESS REPAIR CONTRACT](150-WHEEL-PUBLIC-API-CONTRACT-CURRENTNESS-REPAIR-V1-CONTRACT.md)
7. [149 POST-EVIDENCE-REPAIR TYPED FRONTIER TOURNAMENT](149-POST-EVIDENCE-REPAIR-TYPED-FRONTIER-TOURNAMENT-V1.md)
8. [148 EVIDENCE INDEX TYPED INGESTION & CURRENTNESS REPAIR RESULT](148-EVIDENCE-INDEX-TYPED-INGESTION-CURRENTNESS-REPAIR-V1-RESULT-AND-CLOSEOUT.md)
9. [147 EVIDENCE INDEX TYPED INGESTION & CURRENTNESS REPAIR CONTRACT](147-EVIDENCE-INDEX-TYPED-INGESTION-CURRENTNESS-REPAIR-V1-CONTRACT.md)
10. [146 POST-NO-TOOL-REPAIR TYPED FRONTIER TOURNAMENT](146-POST-NO-TOOL-REPAIR-TYPED-FRONTIER-TOURNAMENT-V1.md)
11. [145 CURRENT NO-TOOL CONCLUSION-CONTROL REGRESSION REPAIR RESULT](145-CURRENT-NO-TOOL-CONCLUSION-CONTROL-REGRESSION-REPAIR-V1-RESULT-AND-CLOSEOUT.md)
12. [144 CURRENT NO-TOOL CONCLUSION-CONTROL REGRESSION REPAIR CONTRACT](144-CURRENT-NO-TOOL-CONCLUSION-CONTROL-REGRESSION-REPAIR-V1-CONTRACT.md)
13. [143 POST-PROVIDER-ROUTE TYPED FRONTIER TOURNAMENT](143-POST-PROVIDER-ROUTE-TYPED-FRONTIER-TOURNAMENT-V1.md)
14. [142 CAMPAIGN-5 PROVIDER-ROUTE PRESERVATION DIRECT DOGFOOD RESULT](142-CAMPAIGN5-PROVIDER-ROUTE-PRESERVATION-DIRECT-DOGFOOD-V1-RESULT-AND-CLOSEOUT.md)
15. [141 CAMPAIGN-5 PROVIDER-ROUTE PRESERVATION DIRECT DOGFOOD CONTRACT](141-CAMPAIGN5-PROVIDER-ROUTE-PRESERVATION-DIRECT-DOGFOOD-V1-CONTRACT.md)
16. [140 POST-RICH-EFFECT TYPED FRONTIER TOURNAMENT](140-POST-RICH-EFFECT-TYPED-FRONTIER-TOURNAMENT-V1.md)
17. [139 CAMPAIGN-3 REAL RICH-EFFECT OWNER DOGFOOD RESULT](139-CAMPAIGN3-REAL-RICH-EFFECT-OWNER-DOGFOOD-V1-RESULT-AND-CLOSEOUT.md)
18. [138 CAMPAIGN-3 REAL RICH-EFFECT OWNER DOGFOOD CONTRACT](138-CAMPAIGN3-REAL-RICH-EFFECT-OWNER-DOGFOOD-V1-CONTRACT.md)
19. [137 TYPED FRONTIER TOURNAMENT v2](137-TYPED-FRONTIER-TOURNAMENT-V2.md)
20. [136 CAMPAIGN-4 REBUTTAL DIRECT DOGFOOD RESULT](136-CAMPAIGN4-COUNTEREVIDENCE-REBUTTAL-DIRECT-DOGFOOD-V1-RESULT-AND-CLOSEOUT.md)
21. [133 CLAIM STANDING MATERIALIZATION + E5-v2 CLOSEOUT](133-CLAIM-STANDING-MINIMAL-MATERIALIZATION-V1-E5V2-RESULT-AND-CLOSEOUT.md)
22. [104 CAMPAIGN-3 HISTORICAL CLOSEOUT](104-CAMPAIGN3-ROUND3-BOUNDARY-AUDIT-AND-CLOSEOUT.md)
23. [116 CAMPAIGN-5 HISTORICAL CLOSEOUT](116-CAMPAIGN5-ROUND3-BOUNDARY-AUDIT-AND-CLOSEOUT.md)
...
Legacy self-identifying receipts retain embedded revision binding and strict verified-currentness invalidation. Post-HTTPX currentness repair 154/155 demoted the then-verified source-reconciliation receipt after 917087e changed its verified implementation paths. Later unreachable-abandonment retirement produced a new bounded verified receipt at 46030ae; canonical batch-search composition 51b942c then changed four paths inside that receipt's verified implementation set. Post-batch-search currentness repair 156/157 therefore demotes that immutable receipt to historical without rerunning or rewriting it. The current evidence contract is green at 80 historical / 0 verified, and no replacement verified receipt is invented. Bounded research standing remains distinct from whole-current implementation certification. The independently exposed wheel API drift was repaired by 150/151; the isolated wheel remains Host-free.

## Campaign-3 currentness update

Historical Campaign-3 closeout correctly recorded general partial/delayed/compensating/interfering engineering cases as conceptual-only at that revision. Current evidence is now split by exact tested scope.

Post-closeout direct dogfood established bounded direct Runtime-owner evidence for a failed two-step plan with realized prefix, delayed evidence across a nonterminal boundary, exact stale/current CAS interference, and later restoration with original Patch history retained.

Strong compact corollary: **Same Final Bytes != Same Operational History.**

Claim Standing required no production change, generic Effect engine, graph or registry.

## Campaign-5 currentness update

Historical Campaign-5 closeout correctly left general provider/locus/internalization proof open.

Post-closeout Provider-Route Preservation Direct Dogfood v1 now establishes bounded direct support for one exact product-authored use contract U over restricted bytes and allowed Provider/Adapter/Model routes. The same exact U admitted both a real `ScriptedTurnAdapter` path and production `DeepSeekTurnAdapter` path under controlled transport; unlisted routes, restricted-byte drift, missing policy and unbound policy injection all failed before adapter construction and durable state creation.

Route admission is explicitly use-relative: the same DeepSeek route admitted under broad U was rejected under a narrower exact U. This is not global Provider equivalence.

The evidence limit remains important: `HarnessProviderUsePolicy` is an endpoint route-membership contract, not a first-class directional transition object. Full directional OPUR, live provider replacement equivalence, locus migration and internalization/externalization remain open.

Fresh Workstation observations still show `surf-clash = UNAVAILABLE` and `finance-okx = UNKNOWN / listener unreachable / no eligible member`; these are real locus-owner facts but do not form a before→after migration pair.

## Campaign-4 currentness update

Historical Campaign-4 closeout correctly recorded independence/counterevidence/cycles/cross-owner composition as conceptual-only at its closeout time. Current state is split: counterevidence/rebuttal revision has bounded direct product evidence; causal/common-cause independence, support-cycle handling, cross-owner composition and cross-implementation reproduction remain open.

## Continuity

- `task:harness-next-conversation-handoff-20260819`
