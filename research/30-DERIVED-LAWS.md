# 30 — DERIVED HARNESS CORE LAWS

These laws are derived syntheses over the frozen HaF corpus and completed bounded Harness research campaigns. They are not additional numbered Foundations.
...
- Composition requires explicit interfaces, assumptions, shared-resource/environment conditions, and dependency evidence.
- Physical execution truth belongs to Runtime; cross-locus substrate truth belongs to Network; normative correctness belongs to Ordivon Normative; human-native cognition/social truth belongs to Human; other domain truth remains with the corresponding owner.
