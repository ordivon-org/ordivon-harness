...
class OrdivonHarnessOH1Tests(unittest.TestCase):
    def test_first_party_manifest_is_conservative_and_stable(self) -> None:
        ...
        self.assertIn("ordivon.live-semantic-events.v1", manifest.extensions)
        self.assertIn("ordivon.provider-retry-budget.v1", manifest.extensions)
        self.assertIn("ordivon.provider-usage-token-budget.v1", manifest.extensions)
        self.assertIn("ordivon.tool-correction-budget.v1", manifest.extensions)
        self.assertIn("ordivon.no-progress-budget.v1", manifest.extensions)
        self.assertIn("ordivon.provider-token-preflight.v1", manifest.extensions)
        self.assertIn("ordivon.observation-message-bound.v1", manifest.extensions)
        self.assertIn("ordivon.runtime-patch-receipt.v1", manifest.extensions)
